...
func (uc *UsersCreate) SetRandSecurity(s string) *UsersCreate {
	uc.mutation.SetRandSecurity(s)
	return uc
}

// SetNillableRandSecurity sets the "rand_security" field if the given value is not nil.
func (uc *UsersCreate) SetNillableRandSecurity(s *string) *UsersCreate {
	if s != nil {
		uc.SetRandSecurity(*s)
	}
	return uc
}

// SetPasswordToken sets the "password_token" field.
func (uc *UsersCreate) SetPasswordToken(s string) *UsersCreate {
	uc.mutation.SetPasswordToken(s)
	return uc
}

// SetNillablePasswordToken sets the "password_token" field if the given value is not nil.
func (uc *UsersCreate) SetNillablePasswordToken(s *string) *UsersCreate {
	if s != nil {
		uc.SetPasswordToken(*s)
	}
	return uc
}
...
func (uc *UsersCreate) check() error {
	...
	if v, ok := uc.mutation.PasswordToken(); ok {
...
func (uc *UsersCreate) createSpec() (*Users, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.RandSecurity(); ok {
		_spec.SetField(users.FieldRandSecurity, field.TypeString, value)
		_node.RandSecurity = &value
	}
	if value, ok := uc.mutation.PasswordToken(); ok {
		_spec.SetField(users.FieldPasswordToken, field.TypeString, value)
		_node.PasswordToken = &value
	}
